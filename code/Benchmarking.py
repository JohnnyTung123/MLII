"""
Single-factor benchmark backtest — JKP 2023 USA data.
...
Results are saved to data/backtest/benchmark/ and a summary plot is produced.

Usage:
    python code/benchmark.py                        # full run
    python code/benchmark.py --start 1995 --tc 5   # custom start year / TC
    python code/benchmark.py --top 30               # show top 30 factors
"""
...
BENCH_DIR = _ROOT / "data" / "backtest" / "benchmark"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Single-factor benchmark backtest on JKP USA data."
    )
    parser.add_argument(
    ...
    print("\nDone. Use these results to set your LASSO benchmark target:")
